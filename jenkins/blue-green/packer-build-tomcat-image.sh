...
function install_packer() {
  if !(command -v packer >/dev/null); then
    ...
    wget https://releases.hashicorp.com/packer/1.1.2/packer_1.1.2_linux_amd64.zip -O packer.zip
...
wget "${artifacts_location}jenkins/blue-green/packer-tomcat.json${artifacts_location_sas_token}" -O packer-tomcat.json
